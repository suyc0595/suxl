...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <!--引用百度地图API-->
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=abkgnugq7jcjujXVpRKskVGiTU0z8d4I"></script>
  </head>
  ...
  <script type="text/javascript">
    ...
    function createMap(){ 
      ...
      map.centerAndZoom(new BMap.Point(118.686001,24.877071),12);
    }
